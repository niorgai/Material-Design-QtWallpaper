...
import us.wili.qtwallpaper.global.QTApplication;
...
public class GridAdapter extends RecyclerView.Adapter {
    ...
    class GridViewHolder extends RecyclerView.ViewHolder {
        ...
        public GridViewHolder(View itemView) {
            ...
            QTApplication application = (QTApplication) mContext.getApplicationContext();
            //set random loading color
            mSimpleDraweeView.setHierarchy(application.getRandomBuilder());
        }
    }
}
